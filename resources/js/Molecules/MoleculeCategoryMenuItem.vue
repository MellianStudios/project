<template>
    <li class="mr-3 flex-1">
        <a href="#" class="block py-1 md:py-3 pl-1 align-middle text-white no-underline hover:text-white border-b-2 border-gray-800 hover:border-pink-500" :id="'category_' + category.id" @click="$emit('clickedCategory', $event.currentTarget)">
